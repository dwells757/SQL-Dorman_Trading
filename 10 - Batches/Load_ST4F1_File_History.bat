DEL C:\React\ST4F1_File_History\Load_ST4F1_File_History_%1.log

SET Log=C:\React\ST4F1_File_History\Load_ST4F1_File_History_%1.log
...
echo COPY "\\192.168.89.212\e$\inetpub\ftproot\GMI\Dorman Reports\GMIST4F1%1.zip" >> %Log%
COPY "\\192.168.89.212\e$\inetpub\ftproot\GMI\Dorman Reports\GMIST4F1%1.zip" >> %Log%

echo "C:\Program Files\7-Zip\7z" e *%1.zip >> %Log%
"C:\Program Files\7-Zip\7z" e *%1.zip >> %Log%

echo DIR C:\React\ST4F1_File_History\*%1*.csv >> %Log%
DIR C:\React\ST4F1_File_History\*%1*.csv >> %Log%
REM **************************************************************
...
REM **************************************************************
echo bcp GMIDATA..GMIPOSF1_File_Raw in C:\React\ST4F1_File_History\GMIPOSF1%1.csv -f C:\React\Code\Format_Files\GMIPOSF1_File.xml -m50 -S REACT -T -h"TABLOCK" -F 2 >> %Log%
bcp GMIDATA..GMIPOSF1_File_Raw in C:\React\ST4F1_File_History\GMIPOSF1%1.csv -f C:\React\Code\Format_Files\GMIPOSF1_File.xml -m50 -S REACT -T -h"TABLOCK" -F 2 >> %Log%

echo bcp GMIDATA..GMIST4F1_File_Raw in C:\React\ST4F1_File_History\GMIST4F1%1.csv -f C:\React\Code\Format_Files\GMIST4F1_File.xml -m50 -S REACT -T -h"TABLOCK" -F 2 >> %Log%
bcp GMIDATA..GMIST4F1_File_Raw in C:\React\ST4F1_File_History\GMIST4F1%1.csv -f C:\React\Code\Format_Files\GMIST4F1_File.xml -m50 -S REACT -T -h"TABLOCK" -F 2 >> %Log%
REM **************************************************************
