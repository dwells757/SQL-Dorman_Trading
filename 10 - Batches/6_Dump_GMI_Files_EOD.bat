...
echo sqlcmd -E -Q"[GMIDATA].[dbo].[PROC_Generate_End_of_Day_Position_File_by_Account_Group] 'SILVERCAPE_INVSMT'" -S DORT-DB-1 -b -h-1 -W -o SILVERCAPE_INVSMT_End_of_Day_Position_File_by_Account.csv >> %Log%
sqlcmd -E -Q"[GMIDATA].[dbo].[PROC_Generate_End_of_Day_Position_File_by_Account_Group] 'SILVERCAPE_INVSMT'" -S DORT-DB-1 -b -h-1 -W -o SILVERCAPE_INVSMT_End_of_Day_Position_File_by_Account.csv >> %Log%
...
echo sqlcmd -E -Q"[GMIDATA].[dbo].[PROC_Generate_End_of_Day_Position_File_by_Related_Account] 'D-153-10012'" -S DORT-DB-1 -b -h-1 -W -o SILVERCAPE_INVSMT_End_of_Day_Position_File_by_Related_Account.csv >> %Log%
sqlcmd -E -Q"[GMIDATA].[dbo].[PROC_Generate_End_of_Day_Position_File_by_Related_Account] 'D-153-10012'" -S DORT-DB-1 -b -h-1 -W -o SILVERCAPE_INVSMT_End_of_Day_Position_File_by_Related_Account.csv >> %Log%
