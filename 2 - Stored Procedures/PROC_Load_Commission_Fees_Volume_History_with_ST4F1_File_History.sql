...
DROP PROCEDURE [dbo].[PROC_Load_Commission_Fees_Volume_History_with_ST4F1_File_History]
GO
...
CREATE PROCEDURE [dbo].[PROC_Load_Commission_Fees_Volume_History_with_ST4F1_File_History]
																					@Start_Date DATE,
																					@End_Date DATE
...
PRINT '************************************************************************************************************'
PRINT ' [dbo].[PROC_Load_Commission_Fees_Volume_History_with_ST4F1_File_History] STARTED'
PRINT '************************************************************************************************************'
...
AND (PCLASS IN('C','H')) --"Customer" or "House" Records ONLY
GROUP BY
Processing_Date,
PFIRM,
POFFIC,
...
PRINT ' WHERE (Processing_Date BETWEEN "' + CONVERT(VARCHAR,@Start_Date,101) + '" and "' + CONVERT(VARCHAR,@End_Date,101) + '")'
PRINT '**************************************************************************'
...
PRINT '************************************************************************************************************'
PRINT ' [dbo].[PROC_Load_Commission_Fees_Volume_History_with_ST4F1_File_History] ENDED'
PRINT '************************************************************************************************************'
SELECT GETDATE() "End Time"
