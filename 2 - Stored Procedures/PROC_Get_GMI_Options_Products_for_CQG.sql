DROP PROCEDURE [dbo].[PROC_Get_GMI_Options_Products_for_CQG]
GO
...
CREATE PROCEDURE [dbo].[PROC_Get_GMI_Options_Products_for_CQG]
...
--PRINT '************************************************************************************************************'
--PRINT ' [dbo].[PROC_Get_GMI_Options_Products_for_CQG] STARTED'
--PRINT '************************************************************************************************************'
...
GMI_Strike_Price NUMERIC(15,8),
GMI_to_CQG_Strike_Price_Multiplier NUMERIC(19,9) DEFAULT 1,
CQG_Strike_Price NUMERIC(15,8) DEFAULT 0,
int_CQG_Strike_Price INT DEFAULT 0,
...
PFC, --GMI_Symbol,
PTYPE, --GMI_Type,
RTRIM(PCTYM) + RTRIM(PSBCUS), --GMI_Expiry,
...
GMI_to_CQG_Strike_Price_Multiplier=B.GMI_to_CQG_Strike_Price_Multiplier
...
UPDATE #GMIPOSF1_File_Current
SET
YY = SUBSTRING(GMI_Expiry,3,2),
MM = SUBSTRING(GMI_Expiry,5,2)
...
--***********************************************************************************************************
-- Generate CQG_Strike_Price
--***********************************************************************************************************
UPDATE #GMIPOSF1_File_Current
SET CQG_Strike_Price = GMI_Strike_Price * GMI_to_CQG_Strike_Price_Multiplier

--***********************************************************************************************************
-- Generate int_CQG_Strike_Price
--***********************************************************************************************************
UPDATE #GMIPOSF1_File_Current
SET int_CQG_Strike_Price = CQG_Strike_Price

--***********************************************************************************************************
-- Generate CQG_Product
--***********************************************************************************************************
UPDATE #GMIPOSF1_File_Current
SET CQG_Product = GMI_Put_Call + '.US.' + REPLACE(CQG_Symbol,' ','') + Month_Code + YY + CONVERT(VARCHAR,int_CQG_Strike_Price)
...
--PRINT '************************************************************************************************************'
--PRINT ' [dbo].[PROC_Get_GMI_Options_Products_for_CQG] ENDED'
--PRINT '************************************************************************************************************'
