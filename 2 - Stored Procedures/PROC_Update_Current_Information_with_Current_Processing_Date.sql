...
DROP PROCEDURE [dbo].[PROC_Update_Current_Information_with_Current_Processing_Date]
GO
...
CREATE PROCEDURE [dbo].[PROC_Update_Current_Information_with_Current_Processing_Date]
...
PRINT '************************************************************************************************************'
PRINT ' [dbo].[PROC_Update_Current_Information_with_Current_Processing_Date] STARTED'
PRINT '************************************************************************************************************'
...
SELECT @str_Current_Processing_Date=MAX(Current_Processing_Date)
...
PRINT '************************************************************************************************************'
PRINT ' [dbo].[PROC_Update_Current_Information_with_Current_Processing_Date] ENDED'
PRINT '************************************************************************************************************'
