...
DROP PROCEDURE [dbo].[PROC_Dump_GMIMNYF1_File_Current_by_Office]
GO
...
CREATE PROCEDURE [dbo].[PROC_Dump_GMIMNYF1_File_Current_by_Office]
																@MOFFIC VARCHAR(3)
...
--PRINT '************************************************************************************************************'
--PRINT ' [dbo].[PROC_Dump_GMIMNYF1_File_Current_by_Office] STARTED'
--PRINT '************************************************************************************************************'
...
--PRINT '************************************************************************************************************'
--PRINT ' [dbo].[PROC_Dump_GMIMNYF1_File_Current_by_Office] ENDED'
--PRINT '************************************************************************************************************'
