...
DROP PROCEDURE [dbo].[PROC_Generate_Risk_Report]
GO
...
CREATE PROCEDURE [dbo].[PROC_Generate_Risk_Report]
...
--PRINT '************************************************************************************************************'
--PRINT ' [dbo].[PROC_Generate_Risk_Report] STARTED'
--PRINT '************************************************************************************************************'
...
--PRINT '************************************************************************************************************'
--PRINT ' [dbo].[PROC_Generate_Risk_Report] ENDED'
--PRINT '************************************************************************************************************'
